...
def pay_order(order_id: int, body: PayIn):
    ...
    try:
        ...
        total = int(row["total"])
        paid_amount = int(body.paid_amount)
        ...
        """, (method, paid_amount, change_amount, paid_at, order_id))
...
@app.get("/report/today-total", tags=["Report"], summary="今日總營收")
